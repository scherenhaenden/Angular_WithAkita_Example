...
@Component({
  selector: 'app-inputside-acomponent',
  templateUrl: './inputside-acomponent.component.html',
  styleUrls: ['./inputside-acomponent.component.scss']
})
export class InputsideAComponentComponent implements OnInit {
